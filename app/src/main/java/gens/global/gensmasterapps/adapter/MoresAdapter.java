...
import gens.global.gensmasterapps.activity.TransaksiActivity;
import gens.global.gensmasterapps.model.ProdukModel;

public class MoresAdapter extends RecyclerView.Adapter<MoresAdapter.MyViewHolder>{
    List<ProdukModel> produkModelList;
    Context context;
    public MoresAdapter(Context context, List<ProdukModel> produkModelList){
